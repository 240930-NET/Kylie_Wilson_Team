...
namespace StringManipulationChallenge
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //  userInput = int.TryParse(UserInput);
            /*
            *
        ...
        /// <returns></returns>
        public static string StringSubstring(string substring, int firstElement, int lengthOfSubstring)
        {
            string Subs = substring.Substring(firstElement,lengthOfSubstring);
            return Subs;
        }
